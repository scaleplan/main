...
interface ConfigConstants
{
    ...
    public const SERVICES_NAMESPACE     = 'SERVICES_NAMESPACE';
    public const SERVICES_POSTFIX       = 'CONTROLLERS_POSTFIX';
    public const REPOSITORIES_NAMESPACE = 'REPOSITORIES_NAMESPACE';
    public const REPOSITORIES_POSTFIX   = 'CONTROLLERS_POSTFIX';
    public const MESSAGES_PATH          = 'MESSAGES_PATH';
